								...
								<div class="row">
                                                                    <%
                                                                        try{
                                                                            ...
                                                                            String sql2="select name, url, price,discount ,ratings from product where CategorieID=?";
                                                                            ...
                                                                            ResultSet selected_categorie_rs = pstmp.executeQuery();
                                                                            while(selected_categorie_rs.next())
                                                                            {
                                                                    %>
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
										...
										<div class="product-wrapper mb-30">
											<div class="product-img">
                                                                                            <a href="variation-product.jsp?name=<% out.print(selected_categorie_rs.getString(1));%>">
                                                                                                    <img src="img/categories/<% out.print(selected_categorie_rs.getString(2));%>" alt="<%out.print(selected_categorie_rs.getString(1));%>" class="primary" style="height:200px;width: 200px;" />
                                                                                                    <img src="img/categories/<% out.print(selected_categorie_rs.getString(2));%>" alt="<%out.print(selected_categorie_rs.getString(1));%>" class="secondary" style="height:200px;width: 200px;"/>
												</a>
												<div class="product-icon">
                                                                                                    <ul>
													<li><a href="add-to-cart.jsp?qtybutton=1&product_name=<% out.print(selected_categorie_rs.getString(1));%>" data-toggle="tooltip" data-placement="top" title="Add to cart"><i class="pe-7s-shopbag"></i></a></li>
													<!--<li><a href="#" data-toggle="modal" data-target="#mymodal" data-placement="top" title="Quick View"><i class="pe-7s-search"></i></a></li>-->
												</ul>
												</div>
											</div>
											<div class="product-content mt-20">
												<h4><a href="#"><% out.print(selected_categorie_rs.getString(1));%></a></h4>
                                                                                                
                                                                                                
                                                                                                <%
                                                                                                    float discount = (float) selected_categorie_rs.getInt(4);
                                                                                                %>
                                                                                                <span>from </span>
                                                                                                <% 
                                                                                                    if(discount>0) { 
                                                                                                        float newprice =  selected_categorie_rs.getInt(3) * (1-(discount/100));
                                                                                                %>
                                                                                                <span class="new-price"><% out.print(" Rs."+newprice);%></span>
                                                                                                <span class="old-price"><del><% out.print(" Rs."+ selected_categorie_rs.getInt(3) );%></del></span>
                                                                                                <% }
                                                                                                    else{
                                                                                                %>
                                                                                                <span class="new-price"><% out.print("Rs."+ selected_categorie_rs.getInt(3) );%></span>
                                                                                                <% } %>

                                                                                                <div class="product-content">
                                                                            <span>Ratings</span>
                                                                            <% if(selected_categorie_rs.getInt(5)==1) {%><span class="fa fa-star checked"></span><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span> <% } %>
                                                                            <% if(selected_categorie_rs.getInt(5)==2) {%><span class="fa fa-star checked"></span><span class="fa fa-star checked"></span><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span> <% } %>
                                                                            <% if(selected_categorie_rs.getInt(5)==3) {%><span class="fa fa-star checked"></span><span class="fa fa-star checked"></span><span class="fa fa-star checked"></span><span class="fa fa-star"></span><span class="fa fa-star"></span> <% } %>
                                                                            <% if(selected_categorie_rs.getInt(5)==4) {%><span class="fa fa-star checked"></span><span class="fa fa-star checked"></span><span class="fa fa-star checked"></span><span class="fa fa-star checked"></span><span class="fa fa-star"></span> <% } %>
                                                                            <% if(selected_categorie_rs.getInt(5)==5) {%><span class="fa fa-star checked"></span><span class="fa fa-star checked"></span><span class="fa fa-star checked"></span><span class="fa fa-star checked"></span><span class="fa fa-star checked"></span> <% } %>
                                                                        </div>
